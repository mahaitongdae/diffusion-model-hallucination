...
if __name__ == "__main__":
    ...
    from plot import plot_scatter_with_custom_true_data
    dist = TwoMoons()
    sampled = dist.sample(2000)
    gen_data = np.load("/home/haitong/PycharmProjects/diffusion-model-hallucination/gaussian_experiments/chkpts/TwoMoonsToyData_200000_rssm_Gaussian_0/gen_dataset.npy")
    # plt.scatter(sampled[:, 0], sampled[:, 1])
    # plt.show()
    plot_scatter_with_custom_true_data(gen_data, "iDEM Generated",
                                       "idem_two_moons.png",
                                       true_data=sampled
                                       )